...
### Metodos login(), registrar()
    ...
    def registrar_usuario(self,nombre, apellido, telefono, username, email, contraseña):
        self.nombre = nombre
        self.apellido = apellido
        self.telefono = telefono
        self.username = username
        ...
        nuevo_usuario = Usuario(len(usuarios) + 1, nombre, apellido, telefono, username, email, contraseña)
...
while True:
    ...
    if opcion == "1":
        ...
        usuario = Usuario()
        usuario.registrar_usuario(nombre, apellido, telefono, username, email, contraseña)
